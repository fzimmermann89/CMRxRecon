...
class MLP(nn.Module):
    ...
    def forward(self, meta_info_vect):
        ...
        return F.sigmoid(self.mlp(meta_info_vect))
...
class CSMFreeReconNN(nn.Module):
    ...
    def __init__(self, 
                 #img_unet=Unet(3, channels_in=2, channels_out=2, layer=3, filters=32, n_convs_per_stage=2), #for  230
                 img_unet=Unet(3, channels_in=2, channels_out=2, layer=1, filters=32, n_convs_per_stage=4), #for  184
