...
class ProxFstarV2(nn.Module):
    ...
    def __init__(self, cnn_block, mode = 'xyt'):
        super(ProxFstarV2, self).__init__()
...
class CSMFreeMultiCoilDataConsPDNetwork(nn.Module):
    ...
    def __init__(self,  
                 ...
                 #FOR EXPERIMENTS
                 prox_g_unet = Unet_felix(3, channels_in=40, channels_out=20, layer=3, conv_per_enc_block=2, conv_per_dec_block=2, filters=32),
                 prox_fstar_unet = Unet_felix(3, channels_in=60, channels_out=20, layer=3, conv_per_enc_block=2, conv_per_dec_block=2, filters=32),
                 T=4):
        super(CSMFreeMultiCoilDataConsPDNetwork, self).__init__()
